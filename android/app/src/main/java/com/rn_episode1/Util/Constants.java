...
public class Constants {
    ...
    public static final int WORK_FREQUENCY = 3;
    ...
    public static final int MIN_GAP_BW_LIVE_NOTIFICATIONS = 15;
    ...
    public static final String NOTIFICATION_MODEL_CATEGORY = "Category";
    ...
    public static final int BASE_WEEK = -1;
